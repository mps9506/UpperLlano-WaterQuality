...
While changes in \gls{do} concentrations are informative, understanding the potential drivers and mechanisms behind those changes would be valuable for land management decisions. 
...
Caveats to this report include substantial bias identified in the \gls{ecoli} load estimations attributed to sparse data collection and lack of high flow sampling events.
...
Furthermore, while the \gls{gamms} estimate of \gls{do} were reasonable, regressing \gls{do} changes with changes in nutrient loads would be informative for land management purposes.
...
While compliance with nutrient water quality standards is not a pressing concern, the resulting sparseness of in-stream nutrient data collected to date precludes a comprehensive assessment of \gls{do} and instream metabolic responses to potential changes in nutrient loads.