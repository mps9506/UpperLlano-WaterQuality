...
Examination of the trends indicate that the parameters are within acceptable ranges for compliance with existing water quality standards. 
However, the GAMM approach identified a decreasing trend in dissolved oxygen concentrations (controlled for season and temperature) at NL1. 
...
In order to provide increasingly reliable load estimates, future sampling efforts need to ensure representativeness of sampling conditions (flow and season). 
...
However, the sparseness of in-stream nutrient data collected to date prevents such analysis. 
Therefore additional monitoring effort is required if accurate estimation of in-stream pollutant loads are desired.