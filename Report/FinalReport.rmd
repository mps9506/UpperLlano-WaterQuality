...
knitr::kable(list(tab3_1, tab3_2, tab3_3),
             ...
             caption = "Reccomended $\\phi$ values for DAR method applied in Texas streams (\\@Asquith2006)",
...
While compliance with nutrient water quality standards is not a priority, the resulting sparseness of in-stream nutrient data collected to date precludes a comprehensive assessment of dissolved oxygen and instream metaboloic responses to potential changes in nutrient loads.